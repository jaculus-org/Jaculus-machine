...
| class | [**NodeModuleLoaderFeature**](classjac_1_1NodeModuleLoaderFeature.md) &lt;class Next&gt;<br> |
...
| class | [**OwnedString**](classjac_1_1OwnedString.md) <br>_An owning RAII handle for a QuickJS-allocated C string._  |
...
| class | [**SimpleModuleLoaderFeature**](classjac_1_1SimpleModuleLoaderFeature.md) &lt;class Next&gt;<br> |
...
| class | [**ValueVector**](classjac_1_1ValueVector.md) <br>_An owning contiguous sequence of JavaScript values._  |
| class | [**ValueVectorWeak**](classjac_1_1ValueVectorWeak.md) <br>_A non-owning view over a contiguous sequence of JavaScript values._  |
...
|  std::tuple&lt; Args... &gt; | [**convertArgs**](#function-convertargs) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, [**ValueVectorWeak**](classjac_1_1ValueVectorWeak.md) argv, std::index\_sequence&lt; Is... &gt;) <br> |
|  JSModuleDef \* | [**createJsonModule**](#function-createjsonmodule) (JSContext \* ctx, const char \* name, JSValue val) <br>_Create a synthetic module whose only export is a default holding the given value._  |
|  T | [**fromValue**](#function-fromvalue) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, [**ValueWeak**](classjac_1_1ValueWrapper.md) val) <br> |
|  int | [**moduleAttributesJsonType**](#function-moduleattributesjsontype) (JSContext \* ctx, JSValueConst attributes) <br>_Determine whether import attributes request a JSON module._  |
...
|  [**Value**](classjac_1_1ValueWrapper.md) | [**processCall**](#function-processcall) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, [**ValueWeak**](classjac_1_1ValueWrapper.md), [**ValueVectorWeak**](classjac_1_1ValueVectorWeak.md) argv, Func & f) <br> |
|  JSValue | [**processCallRaw**](#function-processcallraw) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, JSValueConst thisVal, int argc, JSValueConst \* argv, Func & f) <br> |
|  [**Value**](classjac_1_1ValueWrapper.md) | [**processCallThis**](#function-processcallthis) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, [**ValueWeak**](classjac_1_1ValueWrapper.md) thisVal, [**ValueVectorWeak**](classjac_1_1ValueVectorWeak.md) argv, Func & f) <br> |
|  [**Value**](classjac_1_1ValueWrapper.md) | [**processCallThisVariadic**](#function-processcallthisvariadic) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, [**ValueWeak**](classjac_1_1ValueWrapper.md) thisVal, [**ValueVectorWeak**](classjac_1_1ValueVectorWeak.md) argv, Func & f) <br> |
|  [**Value**](classjac_1_1ValueWrapper.md) | [**processCallVariadic**](#function-processcallvariadic) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, [**ValueWeak**](classjac_1_1ValueWrapper.md), [**ValueVectorWeak**](classjac_1_1ValueVectorWeak.md) argv, Func & f) <br> |
|  JSValue | [**processCallVariadicRaw**](#function-processcallvariadicraw) ([**ContextRef**](classjac_1_1ContextRef.md) ctx, JSValueConst thisVal, int argc, JSValueConst \* argv, Func & f) <br> |
...
|  bool | [**strContains**](#function-strcontains) (const auto & str, const auto & substr) <br> |
|  std::string\_view | [**substring**](#function-substring) (const std::string & str, size\_t pos, size\_t count=std::string::npos) <br> |
...
| Type | Name |
| ---: | :--- |
|  int | [**checkModuleAttributes**](#function-checkmoduleattributes) (JSContext \* ctx, void \*, JSValueConst attributes) <br>_Import-attribute check callback for JS\_SetModuleLoaderFunc2._  |
...
_Create a synthetic module whose only export is a default holding the given value._ 
```C++
inline JSModuleDef * jac::createJsonModule (
    JSContext * ctx,
    const char * name,
    JSValue val
) 
...
_Determine whether import attributes request a JSON module._ 
```C++
inline int jac::moduleAttributesJsonType (
    JSContext * ctx,
...
_Import-attribute check callback for JS\_SetModuleLoaderFunc2._ 
```C++
static int jac::checkModuleAttributes (
    JSContext * ctx,
    void *,
    JSValueConst attributes
) 
