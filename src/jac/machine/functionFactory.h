...
public:
     ...
     * @brief Wraps a C++ function into a javascript function object
     *
     * The expected signature of the function object is Res(@ref
     * ValueVectorWeak). The vector will contain all arguments passed to the
     ...
     *
     * The expected signature of the function object is Res(@ref ContextRef,
     * @ref ValueWeak, @ref ValueVectorWeak). The vector will contain all
