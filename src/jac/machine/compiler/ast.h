...
FunctionPtr parseFunction(ParserState& state, TriState identifierRequired, bool isAsync = false);
...
FunctionPtr parseAsyncFunctionDeclaration(ParserState&, bool);
...
ExpressionPtr parseArrowFunction(ParserState&);
ExpressionPtr parseAsyncArrowFunction(ParserState&);
