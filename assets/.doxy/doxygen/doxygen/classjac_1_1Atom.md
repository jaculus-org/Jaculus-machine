...
|  [**OwnedString**](classjac_1_1OwnedString.md) | [**toString**](#function-tostring) () const<br>_Get string representation of the atom._  |
...
```C++
inline OwnedString jac::Atom::toString () const
```
