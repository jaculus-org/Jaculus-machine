...
Inherited by the following classes: [jac::ObjectWrapper](classjac_1_1ObjectWrapper.md),  [jac::ExceptionWrapper](classjac_1_1ExceptionWrapper.md),  [jac::ObjectWrapper](classjac_1_1ObjectWrapper.md)
...
|  std::string | [**inspect**](#function-inspect-12) (const JSPrintValueOptions & options) <br>_Produce a repl-style representation of the Value._  |
|  std::string | [**inspect**](#function-inspect-22) () <br>_Produce a repl-style representation of the Value with default formatting options._  |
|  bool | [**isArray**](#function-isarray) () <br>_Check if the Value is an array._  |
|  bool | [**isBigInt**](#function-isbigint) () <br>_Check if the Value is BigInt._  |
|  bool | [**isBoolean**](#function-isboolean) () <br>_Check if the Value is boolean._  |
|  bool | [**isFunction**](#function-isfunction) () <br>_Check if the Value is a function._  |
|  bool | [**isInstanceOf**](#function-isinstanceof) ([**ObjectWeak**](classjac_1_1ObjectWrapper.md) obj) <br>_Check if the Value is an instance of the given object._  |
|  bool | [**isNull**](#function-isnull) () <br>_Check if the Value is null._  |
|  bool | [**isNumber**](#function-isnumber) () <br>_Check if the Value is number._  |
|  bool | [**isObject**](#function-isobject) () <br>_Check if the Value is an object._  |
|  bool | [**isString**](#function-isstring) () <br>_Check if the Value is string._  |
|  bool | [**isSymbol**](#function-issymbol) () <br>_Check if the Value is symbol._  |
...
|  [**OwnedString**](classjac_1_1OwnedString.md) | [**toString**](#function-tostring) () <br>_Convert the Value to a_ [_**OwnedString**_](classjac_1_1OwnedString.md) _._ |
...
### function inspect [1/2]

_Produce a repl-style representation of the Value._ 
```C++
inline std::string jac::ValueWrapper::inspect (
...
* `options` formatting options and limits (recursion depth, string length, item count) 
...
### function inspect [2/2]

_Produce a repl-style representation of the Value with default formatting options._ 
```C++
inline std::string jac::ValueWrapper::inspect () 
```
...
_Check if the Value is BigInt._ 
```C++
...
_Check if the Value is boolean._ 
```C++
...
_Check if the Value is an instance of the given object._ 
```C++
...
_Check if the Value is number._ 
```C++
...
_Check if the Value is string._ 
```C++
...
_Check if the Value is symbol._ 
```C++
...
_Convert the Value to a_ [_**OwnedString**_](classjac_1_1OwnedString.md) _._
```C++
inline OwnedString jac::ValueWrapper::toString () 
```
...
The [**OwnedString**](classjac_1_1OwnedString.md) 
